/**
 *  Inovelli Switch NZW30T w/Scene
...
metadata {
	definition (name: "Inovelli Switch NZW30T w/Scene", namespace: "erocm123", author: "Eric Maycock") {
		capability "Switch"
		capability "Refresh"
		capability "Polling"
		capability "Actuator"
        ...
        fingerprint mfr: "0312", prod: "1E02", model: "1E02", deviceJoinName: "Inovelli Switch"
	}
